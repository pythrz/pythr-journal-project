...
Sometimes, you need something to visually break away from any dense text that may be featured in your journals. Borrowing styling from the [D&D5e system](https://github.com/foundryvtt/dnd5e) and allowing it to be used in other game systems, you can easily insert one of these by following these steps:
